...
(()=>{
  ...
  function ui1203(){
    document.documentElement.dataset.baemoonVersion='12.05';
...
(()=>{
  ...
  function ensureGuestPasswordUi(){
    ...
    if(!wrap){
      ...
      wrap.innerHTML='<label class="guest-password-field-v1205"><span>게스트 비밀번호</span><input id="guestPasswordV1205" type="password" autocomplete="current-password" placeholder="비밀번호 입력"></label><div id="guestFirstPasswordV1205"><p><b>최초 로그인</b> 최초 비밀번호 <code>baemoon2026</code>을 입력한 뒤 개인 비밀번호를 설정합니다.</p><label class="guest-password-field-v1205"><span>개인 비밀번호</span><input id="guestNewPasswordV1205" type="password" minlength="8" autocomplete="new-password" placeholder="8자 이상"></label><label class="guest-password-field-v1205"><span>개인 비밀번호 확인</span><input id="guestNewPasswordConfirmV1205" type="password" minlength="8" autocomplete="new-password" placeholder="한 번 더 입력"></label></div><small id="guestAccountRuleV1205">한 브라우저에서는 하나의 게스트 계정만 사용할 수 있습니다.</small>';
...
(()=>{
  ...
  function removeLegacyUi(){document.querySelectorAll('#festivalAdminQuickToggleV1203,.festival-admin-quick-toggle-v1203,#testNotificationV1202,#diagnoseNotificationV1202,#notificationDiagnosticV1202,#testBackgroundPushV1143').forEach(n=>n.remove());document.documentElement.dataset.baemoonVersion='12.05'}
...
/* v13.00.2 emergency recovery: restored v12.05 application core after v13 main-thread lockup. */
