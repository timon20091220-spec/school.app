/* 배문고 Firebase Runtime v11.44 performance loader
...
const CACHE_KEY='baemoon-firebase-runtime-68b50607-v1144';
const OLD_CACHE_KEYS=['baemoon-firebase-runtime-68b50607-v1143','baemoon-firebase-runtime-68b50607-v1142','baemoon-firebase-runtime-68b50607-v1141'];
...
function optimizeRuntime(source){
  ...
  source=source.replace(
    ...
    `async reservationServerHealth(){
      const key='bm-reservation-health-v1144';
...
try{
  ...
  console.error('배문고 Firebase Runtime v11.44 시작 실패:',error);
