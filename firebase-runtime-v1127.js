/* 배문고 Firebase Runtime v13.00 stabilization loader
...
const CACHE_KEY='baemoon-firebase-runtime-68b50607-v1205'; // 기존 캐시 재사용으로 새로고침 속도 유지
...
window.baemoonSetLoginPersistence=applyLoginPersistence;`)
  ...
  console.error('배문고 Firebase Runtime v13.00 시작 실패:',error);
