/* 배문고 Firebase Runtime v12.02 performance loader
...
const CACHE_KEY='baemoon-firebase-runtime-68b50607-v1202';
const OLD_CACHE_KEYS=['baemoon-firebase-runtime-68b50607-v1201','baemoon-firebase-runtime-68b50607-v1144','baemoon-firebase-runtime-68b50607-v1143','baemoon-firebase-runtime-68b50607-v1142','baemoon-firebase-runtime-68b50607-v1141'];
...
function optimizeRuntime(source){
  ...
  source=source.replace(
    ...
    `async reservationServerHealth(){
      const key='bm-reservation-health-v1202';
...
const LOGIN_KEEP_KEY='bm_login_keep_v1202';
...
window.baemoonSetLoginPersistence=applyLoginPersistence;`)
  ...
  console.error('배문고 Firebase Runtime v12.02 시작 실패:',error);
