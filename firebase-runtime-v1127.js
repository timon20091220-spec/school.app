/* 배문고 Firebase Runtime v11.43 performance loader
...
const CACHE_KEY='baemoon-firebase-runtime-68b50607-v1143';
const OLD_CACHE_KEYS=['baemoon-firebase-runtime-68b50607-v1142','baemoon-firebase-runtime-68b50607-v1141'];
...
function optimizeRuntime(source){
  ...
  source=source.replace(
    ...
    `async reservationServerHealth(){
      const key='bm-reservation-health-v1143';
...
try{
  ...
  console.error('배문고 Firebase Runtime v11.43 시작 실패:',error);
