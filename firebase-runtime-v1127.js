/* 배문고 Firebase Runtime v11.42 performance loader
...
const CACHE_KEY='baemoon-firebase-runtime-68b50607-v1142';
const OLD_CACHE_KEYS=['baemoon-firebase-runtime-68b50607-v1141'];
...
function optimizeRuntime(source){
  ...
  source=source.replace(
    ...
    `async reservationServerHealth(){
      const key='bm-reservation-health-v1142';
...
try{
  ...
  console.error('배문고 Firebase Runtime v11.42 시작 실패:',error);
