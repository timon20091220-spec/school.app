...
const state={
  ...
  classChatUnread:0,classChatInitialized:false,adminTimetableGrade:1,adminTimetableClass:1,adminTimetableDrafts:{}
};
...
function ensureServiceWorker(){
  ...
  if(!serviceWorkerRegistrationPromise){
    serviceWorkerRegistrationPromise=navigator.serviceWorker
      .register('./sw-v1124.js',{scope:'./',updateViaCache:'none'})
...
/* v11.24 시간표 저장: 문서 캡처 단계에서 단 한 번만 처리 */
...
/* v11.24 부스 저장: 즉시 예약 허용 + 단일 저장 이벤트 */
document.addEventListener('click',async event=>{
