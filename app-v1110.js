...
function firebaseLoadMessage(error){
  ...
  if(raw.includes('FIREBASE_LOAD_TIMEOUT'))return 'Firebase 연결 시간이 오래 걸리고 있습니다. 네트워크를 확인한 뒤 다시 눌러주세요.';
...
if('serviceWorker'in navigator){
  window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v1110.js',{updateViaCache:'none'}).catch(()=>{}));
}