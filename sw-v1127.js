/* 배문고 학교 앱 Service Worker v11.29 */
const CACHE_NAME='baemoon-school-app-v11.29';
const CORE_ASSETS=[
...
function notificationOptions(payload={}){
  return {
    ...
    tag:String(payload.tag||payload.queueId||'baemoon-queue-call'),
    renotify:true,
    requireInteraction:true,
    vibrate:LONG_VIBRATION,
    data:{url:String(payload.url||'./'),queueId:String(payload.queueId||'')}
  };
}
